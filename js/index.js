...
const closeSeeMore = (event) =>{
    ...
    if(event.target.innerHTML !== btnSeeMore.innerHTML && canCloseResume === true){
        ...
        resume.innerHTML = resumeCopy.innerHTML;
